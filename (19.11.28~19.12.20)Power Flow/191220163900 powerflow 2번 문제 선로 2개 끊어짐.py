...
incidence_matrix[18,14]=0
incidence_matrix[18,20]=0
incidence_matrix[19,14]=0
incidence_matrix[19,20]=0
...
for i in range(len(Branch)):
    ...
    B_matrix[14, 14] -= 2 * Branch[Branch.columns[4]][19] / 2
    B_matrix[20, 20] -= 2 * Branch[Branch.columns[4]][19] / 2
